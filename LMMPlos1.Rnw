...
On 13 November 2017, experts reduced thresholds for diagnosing hypertension from $140$ mm Hg/ $90$ mm Hg to $130$ mm hg/ $80$ mm Hg \cite{WashPost}. The new guidelines note that "higher SBP [systolic blood pressure] and DBP [diastolic blood pressure] were associated with increased risk of" death and disease \cite{Whelton24430, BPArt, HBPRisks}. They recommend "antihypertensive medication... with lifestyle modification" \cite{Whelton24430} to lower BP. Besides lowering elevated BP, investigators could explore treatments that keep low BP low, or have carryover effects: ``prevention is better than treatment'' \cite{Prevention}. Unfortunately, no statistical methodoloy currently tests this hypothesis for this outcome. 

We use Stephen Senn's definition of carryover effects as the ``residual effects'' of treatment after it has ceased \cite{First25Years}. He also notes
...
Researchers have criticised TROPHY's design. Meltzer (2006)
...
the first two years. Because measurements in excess of the
threshold are less likely, incidence of hypertension in the treatment arm are artificially reduced. Defininghypertension as 3 measurements in excess results in lower diagnosis
