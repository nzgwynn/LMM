...
\caption{{\bf Variogram of systolic and diastolic BP.}The relative flatness of the variogram shows no
...
\caption{{\bf Centre of true relative risks. }Because the true relative risk of hypertension is
  ...
  carryover is 0, we test the bootstrap confidence intervals for 1. This test is accurate and achieves our goal. }
\label{gr:RelRisk}
\end{center}
\end{figure}
